  ...
  const compressImage = (base64: string, maxWidth = 1000): Promise<string> => {
    return new Promise((resolve, reject) => {
      ...
      img.onload = () => {
        ...
        // Using image/png to support transparency as requested
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Separator and Course Title requested */}
              <div className="hidden md:flex items-center gap-2">
                <div className="h-4 w-px bg-slate-200 mx-2"></div>
                <span className="text-slate-400 font-medium text-sm truncate max-w-[200px]">{course.title}</span>
              </div>
            </div>
          </div>
        </div>
